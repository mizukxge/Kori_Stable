...
export function SignerListStep({
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-lg font-semibold text-gray-900">Add Signers</h2>
      ...
      {!showForm ? (
        <button
          ...
          className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-center font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 transition-colors"
        >
          + Add Signer
        </button>
      ) : (
        <div className="rounded-lg border border-gray-200 bg-white p-4 space-y-4">
          <h3 className="font-semibold text-gray-900">Add New Signer</h3>
