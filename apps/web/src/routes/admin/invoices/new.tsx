...
import { createInvoice, type InvoiceItem } from '../../../lib/invoices-api';
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="e.g., Photography Services Invoice"
                  required
                />
              </div>
        ...
        <div>
          ...
          <div className="bg-card rounded-lg shadow p-6 mb-6 sticky top-6">
            <h2 className="text-lg font-semibold text-foreground mb-6">Invoice Summary</h2>
