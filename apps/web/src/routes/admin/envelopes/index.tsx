    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600">Manage multi-signature envelopes</p>
        </div>
        <button
      ...
      {stats && (
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4">
            ...
            <p className="mt-2 text-3xl font-bold text-green-600">{stats.byStatus?.COMPLETED || 0}</p>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-4">
            <p className="text-sm text-gray-600">Signers</p>
            <p className="mt-2 text-3xl font-bold text-blue-600">{stats.totalSigners}</p>
          </div>
        </div>
      )}
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="mt-1 text-sm text-gray-500">{envelope.id}</p>
                  </div>
                ...
                <div className="mt-3 flex gap-2">
                  <span className="text-xs inline-block px-2 py-1 bg-gray-100 text-gray-700 rounded">
